...
return function(mapbuf)
	...
	-- goto next error
	mapbuf("n", "ej", "<cmd>lua require('lspsaga.diagnostic').goto_next({ severity = vim.diagnostic.severity.ERROR })<cr>", opt)
	-- goto prev error
	mapbuf("n", "ek", "<cmd>lua require('lspsaga.diagnostic').goto_prev({ severity = vim.diagnostic.severity.ERROR })<cr>", opt)
